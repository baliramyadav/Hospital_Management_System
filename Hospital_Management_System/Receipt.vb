...
Public Class Receipt
    ...
    Private Sub Receipt_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Label7.Text = My.Forms.Discharge.b
        Label8.Text = My.Forms.Discharge.cn
        Label9.Text = "medical treatment"
        Label10.Text = My.Forms.Discharge.t
        Label13.Text = My.Forms.Discharge.d
